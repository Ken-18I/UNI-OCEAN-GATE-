...
#Definimos el fondo de mar con movimiento, para hacer una simulacion del submarino sumergiendose cada vez mas
class Background(pygame.sprite.Sprite):
    def __init__(self):
        super(Background, self).__init__()

        self.surf = pygame.image.load("sprites/mar_1.png")
        background_width = SCREEN_WIDTH * 2 #definimos el doble de ancho
        ...
        #Estos se mueven juntos y cuando uno desaparece de pantalla se mueve hasta abajo, y asi se van repitiendo
